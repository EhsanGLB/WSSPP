...
)
{
    ...
    forAll(WSSPP.boundaryField(), patchI)
    {
        WSSPP.boundaryField()[patchI] = rho.value() *
        (
...
int main(int argc, char *argv[])
{
    ...
    forAll(timeDirs, timeI)
    {
        ...
        if (UHeader.headerOk())
        {
            ...
            if (compressible)
            {
                calcCompressible(mesh, runTime, U, WSSPP);
            }
            else
            {
                calcIncompressible(mesh, runTime, U, WSSPP);
            }
        }
        else
        {
        ...
        Info<< "Writing wall shear stress to field " << WSSPP.name() << nl << endl;
